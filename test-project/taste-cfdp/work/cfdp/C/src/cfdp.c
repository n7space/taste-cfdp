...
void cfdp_PI_init(const asn1SccGAMMA_CFDP_CONFIG_DATA *IN_entity_id,
		  const asn1SccGAMMA_CFDP_CHECKSUM_TYPE *IN_checksum_type,
		  const asn1SccGAMMA_CFDP_CONFIG_DATA *IN_inactivity_time)
{
...
void cfdp_PI_file_handling_request_copy_file_operation( const asn1SccGAMMA_OPERATION_ID *IN_operation_id, const asn1SccGAMMA_FILE_PATH *IN_source_file_path, const asn1SccGAMMA_CFDP_CONFIG_DATA *IN_destination_id, const asn1SccGAMMA_FILE_PATH *IN_target_file_path, const asn1SccROOT_REQUEST_ID *IN_request_id, const asn1SccROOT_TC_SECONDARY_HEADER *IN_secondary_header )
{
