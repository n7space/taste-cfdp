...
/* Provided interfaces */
void cfdp_PI_cfdp_copy_operation_id_alredy_allocated( const asn1SccGAMMA_OPERATION_ID *, asn1SccGAMMA_BOOLEAN * );
...
void cfdp_PI_cfdp_transport_is_ready_callback( void );
