#ifndef GENERATED_CFDP_ASN1SCC_dataview_H
#define GENERATED_CFDP_ASN1SCC_dataview_H
/*
...
#define cfdpFileDirectivePDU_REQUIRED_BYTES_FOR_ACN_ENCODING       263
#define cfdpFileDirectivePDU_REQUIRED_BITS_FOR_ACN_ENCODING        2104
...
typedef enum {
    MessageType_originating_transaction_id = 10,
    MessageType_directory_listing_request = 16,
    MessageType_directory_listing_response = 17
} cfdpMessageType;

// please use the following macros to avoid breaking code.
#define cfdpMessageType_originating_transaction_id MessageType_originating_transaction_id
...
#define ERR_MESSAGETYPE		651  /*originating-transaction-id | directory-listing-request | directory-listing-response*/
...
#else
#define cfdpMessageType_constant MessageType_originating_transaction_id
#endif
...
#define cfdpMessageType_REQUIRED_BITS_FOR_ENCODING        2
...
#define ERR_ORIGINATINGTRANSACTIONID		745  /**/
#define ERR_ORIGINATINGTRANSACTIONID_SOURCE_ENTITY_ID_2		734  /**/
#define ERR_ORIGINATINGTRANSACTIONID_TRANSACTION_SEQUENCE_NUMBER_2		742  /**/
flag cfdpOriginatingTransactionId_IsConstraintValid(const cfdpOriginatingTransactionId* pVal, int* pErrCode);

#ifdef __cplusplus
extern const cfdpOriginatingTransactionId cfdpOriginatingTransactionId_constant;
#else
#define cfdpOriginatingTransactionId_constant {.source_entity_id = {.nCount = 1, .arr  = {[0 ... 7-1] = 0 }}, .transaction_sequence_number = {.nCount = 1, .arr  = {[0 ... 7-1] = 0 }}}
#endif

void cfdpOriginatingTransactionId_Initialize(cfdpOriginatingTransactionId* pVal);

#define ERR_UPER_ENCODE_ORIGINATINGTRANSACTIONID		746  /**/
#define ERR_UPER_ENCODE_ORIGINATINGTRANSACTIONID_SOURCE_ENTITY_ID_2		735  /**/
#define ERR_UPER_ENCODE_ORIGINATINGTRANSACTIONID_TRANSACTION_SEQUENCE_NUMBER_2		743  /**/
#define cfdpOriginatingTransactionId_REQUIRED_BYTES_FOR_ENCODING       15
#define cfdpOriginatingTransactionId_REQUIRED_BITS_FOR_ENCODING        118
...
#define ERR_UPER_DECODE_ORIGINATINGTRANSACTIONID		747  /**/
#define ERR_UPER_DECODE_ORIGINATINGTRANSACTIONID_SOURCE_ENTITY_ID_2		736  /**/
#define ERR_UPER_DECODE_ORIGINATINGTRANSACTIONID_TRANSACTION_SEQUENCE_NUMBER_2		744  /**/
flag cfdpOriginatingTransactionId_Decode(cfdpOriginatingTransactionId* pVal, BitStream* pBitStrm, int* pErrCode);

#define cfdpOriginatingTransactionId_REQUIRED_BYTES_FOR_ACN_ENCODING       15
#define cfdpOriginatingTransactionId_REQUIRED_BITS_FOR_ACN_ENCODING        120

#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID		748  /**/
#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID_RESERVED1		721  /**/
#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID_LENGTH_OF_ENTITY_IDS_UNINITIALIZED		749  /**/
#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID_LENGTH_OF_ENTITY_IDS		723  /**/
#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID_RESERVED2		725  /**/
#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID_LENGTH_OF_TRANSACTION_SEQUENCE_NUMBER_UNINITIALIZED		750  /**/
#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID_LENGTH_OF_TRANSACTION_SEQUENCE_NUMBER		727  /**/
#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID_SOURCE_ENTITY_ID		732  /**/
#define ERR_ACN_ENCODE_ORIGINATINGTRANSACTIONID_TRANSACTION_SEQUENCE_NUMBER		740  /**/
...
#define ERR_ACN_DECODE_ORIGINATINGTRANSACTIONID		751  /**/
#define ERR_ACN_DECODE_ORIGINATINGTRANSACTIONID_RESERVED1		722  /**/
#define ERR_ACN_DECODE_ORIGINATINGTRANSACTIONID_LENGTH_OF_ENTITY_IDS		724  /**/
#define ERR_ACN_DECODE_ORIGINATINGTRANSACTIONID_RESERVED2		726  /**/
#define ERR_ACN_DECODE_ORIGINATINGTRANSACTIONID_LENGTH_OF_TRANSACTION_SEQUENCE_NUMBER		728  /**/
#define ERR_ACN_DECODE_ORIGINATINGTRANSACTIONID_SOURCE_ENTITY_ID		733  /**/
#define ERR_ACN_DECODE_ORIGINATINGTRANSACTIONID_TRANSACTION_SEQUENCE_NUMBER		741  /**/
...
#define ERR_PDUHEADER		822  /**/
#define ERR_PDUHEADER_VERSION_2		757  /**/
#define ERR_PDUHEADER_DIRECTION_2		767  /**/
#define ERR_PDUHEADER_TRANSMISSION_MODE_2		777  /**/
#define ERR_PDUHEADER_CRC_FLAG_2		787  /**/
#define ERR_PDUHEADER_SOURCE_ENTITY_ID_2		797  /**/
#define ERR_PDUHEADER_TRANSACTION_SEQUENCE_NUMBER_2		807  /**/
#define ERR_PDUHEADER_DESTINATION_ENTITY_ID_2		817  /**/
...
#define ERR_UPER_ENCODE_PDUHEADER		823  /**/
#define ERR_UPER_ENCODE_PDUHEADER_VERSION_2		758  /**/
#define ERR_UPER_ENCODE_PDUHEADER_DIRECTION_2		768  /**/
#define ERR_UPER_ENCODE_PDUHEADER_TRANSMISSION_MODE_2		778  /**/
#define ERR_UPER_ENCODE_PDUHEADER_CRC_FLAG_2		788  /**/
#define ERR_UPER_ENCODE_PDUHEADER_SOURCE_ENTITY_ID_2		798  /**/
#define ERR_UPER_ENCODE_PDUHEADER_TRANSACTION_SEQUENCE_NUMBER_2		808  /**/
#define ERR_UPER_ENCODE_PDUHEADER_DESTINATION_ENTITY_ID_2		818  /**/
...
#define ERR_UPER_DECODE_PDUHEADER		824  /**/
#define ERR_UPER_DECODE_PDUHEADER_VERSION_2		759  /**/
#define ERR_UPER_DECODE_PDUHEADER_DIRECTION_2		769  /**/
#define ERR_UPER_DECODE_PDUHEADER_TRANSMISSION_MODE_2		779  /**/
#define ERR_UPER_DECODE_PDUHEADER_CRC_FLAG_2		789  /**/
#define ERR_UPER_DECODE_PDUHEADER_SOURCE_ENTITY_ID_2		799  /**/
#define ERR_UPER_DECODE_PDUHEADER_TRANSACTION_SEQUENCE_NUMBER_2		809  /**/
#define ERR_UPER_DECODE_PDUHEADER_DESTINATION_ENTITY_ID_2		819  /**/
...
#define ERR_ACN_ENCODE_PDUHEADER		825  /**/
#define ERR_ACN_ENCODE_PDUHEADER_VERSION_2		760  /**/
#define ERR_ACN_ENCODE_PDUHEADER_DIRECTION_2		770  /**/
#define ERR_ACN_ENCODE_PDUHEADER_TRANSMISSION_MODE_2		780  /**/
#define ERR_ACN_ENCODE_PDUHEADER_CRC_FLAG_2		790  /**/
#define ERR_ACN_ENCODE_PDUHEADER_SOURCE_ENTITY_ID_2		800  /**/
#define ERR_ACN_ENCODE_PDUHEADER_TRANSACTION_SEQUENCE_NUMBER_2		810  /**/
#define ERR_ACN_ENCODE_PDUHEADER_DESTINATION_ENTITY_ID_2		820  /**/

flag cfdpPDUHeader_ACN_Encode(const cfdpPDUHeader* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_ACN_DECODE_PDUHEADER		826  /**/
#define ERR_ACN_DECODE_PDUHEADER_VERSION_2		761  /**/
#define ERR_ACN_DECODE_PDUHEADER_DIRECTION_2		771  /**/
#define ERR_ACN_DECODE_PDUHEADER_TRANSMISSION_MODE_2		781  /**/
#define ERR_ACN_DECODE_PDUHEADER_CRC_FLAG_2		791  /**/
#define ERR_ACN_DECODE_PDUHEADER_SOURCE_ENTITY_ID_2		801  /**/
#define ERR_ACN_DECODE_PDUHEADER_TRANSACTION_SEQUENCE_NUMBER_2		811  /**/
#define ERR_ACN_DECODE_PDUHEADER_DESTINATION_ENTITY_ID_2		821  /**/
...
#define ERR_CFDPPDU		1116  /**/
#define ERR_CFDPPDU_PDU_HEADER_2		1113  /**/
#define ERR_CFDPPDU_PAYLOAD_2		1029  /**/
...
#define ERR_UPER_ENCODE_CFDPPDU		1117  /**/
#define ERR_UPER_ENCODE_CFDPPDU_PDU_HEADER_2		1114  /**/
#define ERR_UPER_ENCODE_CFDPPDU_PAYLOAD_2		1030  /**/
...
#define ERR_UPER_DECODE_CFDPPDU		1118  /**/
#define ERR_UPER_DECODE_CFDPPDU_PDU_HEADER_2		1115  /**/
#define ERR_UPER_DECODE_CFDPPDU_PAYLOAD_2		1031  /**/
...
#define ERR_ACN_ENCODE_CFDPPDU		1119  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER		1111  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_VERSION		1037  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_PDU_TYPE_UNINITIALIZED		1120  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_PDU_TYPE		1042  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_DIRECTION		1047  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_TRANSMISSION_MODE		1055  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_CRC_FLAG		1063  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_LARGE_FILE_FLAG		1068  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD		1027  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE		1006  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_DIRECTIVE_CODE_UNINITIALIZED		1072  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_DIRECTIVE_CODE		827  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU		998  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU		858  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU_CONDITION_CODE		832  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU_SPARE		837  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU_FILE_CHECKSUM		842  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU_FILE_SIZE		850  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU		892  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU_CONDITION_CODE		866  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU_END_SYSTEM_STATUS		871  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU_DELIVERY_CODE		876  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU_FILE_STATUS		884  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU		934  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_DIRECTIVE_CODE_OF_ACK_PDU		900  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_DIRECTIVE_SUBTYPE_CODE		908  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_CONDITION_CODE		916  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_SPARE		921  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_TRANSACTION_STATUS		926  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU		990  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_RESERVED1		939  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_CLOSURE_REQUESTED		944  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_RESERVED2		949  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_CHECKSUM_TYPE		954  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_FILE_SIZE		962  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_SOURCE_FILE_NAME_SIZE_UNINITIALIZED		1073  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_SOURCE_FILE_NAME_SIZE		967  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_SOURCE_FILE_NAME		972  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_DESTINATION_FILE_NAME_SIZE_UNINITIALIZED		1074  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_DESTINATION_FILE_NAME_SIZE		977  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_DESTINATION_FILE_NAME		982  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DATA		1019  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DATA_FILE_DATA_PDU		1014  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_PDU_DATA_FIELD_LENGTH_UNINITIALIZED		1121  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_PDU_DATA_FIELD_LENGTH		1070  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_SEGMENTATION_CONTROL		1075  /**/
#define ERR_ACN_ENCODE_UPDATE_CFDPPDU_PDU_HEADER_LENGTH_OF_ENTITY_IDS		1079  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_LENGTH_OF_ENTITY_IDS_UNINITIALIZED		1122  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_LENGTH_OF_ENTITY_IDS		1077  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_SEGMENT_METADATA_FLAG		1080  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_LENGTH_OF_TRANSACTION_SEQUENCE_NUMBER_UNINITIALIZED		1123  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_LENGTH_OF_TRANSACTION_SEQUENCE_NUMBER		1082  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_SOURCE_ENTITY_ID		1087  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_TRANSACTION_SEQUENCE_NUMBER		1095  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PDU_HEADER_DESTINATION_ENTITY_ID		1103  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_2		1032  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_DIRECTIVE_CODE_UNINITIALIZED_2		1124  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_SOURCE_FILE_NAME_SIZE_UNINITIALIZED_2		1125  /**/
#define ERR_ACN_ENCODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_DESTINATION_FILE_NAME_SIZE_UNINITIALIZED_2		1126  /**/

flag cfdpCfdpPDU_ACN_Encode(const cfdpCfdpPDU* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_ACN_DECODE_CFDPPDU		1127  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER		1112  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_VERSION		1038  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_PDU_TYPE		1043  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_DIRECTION		1048  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_TRANSMISSION_MODE		1056  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_CRC_FLAG		1064  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_LARGE_FILE_FLAG		1069  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_PDU_DATA_FIELD_LENGTH		1071  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_SEGMENTATION_CONTROL		1076  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_LENGTH_OF_ENTITY_IDS		1078  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_SEGMENT_METADATA_FLAG		1081  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_LENGTH_OF_TRANSACTION_SEQUENCE_NUMBER		1083  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_SOURCE_ENTITY_ID		1088  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_TRANSACTION_SEQUENCE_NUMBER		1096  /**/
#define ERR_ACN_DECODE_CFDPPDU_PDU_HEADER_DESTINATION_ENTITY_ID		1104  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_2		1033  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD		1028  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE		1007  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_DIRECTIVE_CODE		828  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU		999  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU		859  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU_CONDITION_CODE		833  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU_SPARE		838  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU_FILE_CHECKSUM		843  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_EOF_PDU_FILE_SIZE		851  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU		893  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU_CONDITION_CODE		867  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU_END_SYSTEM_STATUS		872  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU_DELIVERY_CODE		877  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_FINISHED_PDU_FILE_STATUS		885  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU		935  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_DIRECTIVE_CODE_OF_ACK_PDU		901  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_DIRECTIVE_SUBTYPE_CODE		909  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_CONDITION_CODE		917  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_SPARE		922  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_ACK_PDU_TRANSACTION_STATUS		927  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU		991  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_RESERVED1		940  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_CLOSURE_REQUESTED		945  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_RESERVED2		950  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_CHECKSUM_TYPE		955  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_FILE_SIZE		963  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_SOURCE_FILE_NAME_SIZE		968  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_SOURCE_FILE_NAME		973  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_DESTINATION_FILE_NAME_SIZE		978  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DIRECTIVE_FILE_DIRECTIVE_PDU_METADATA_PDU_DESTINATION_FILE_NAME		983  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DATA		1020  /**/
#define ERR_ACN_DECODE_CFDPPDU_PAYLOAD_FILE_DATA_FILE_DATA_PDU		1015  /**/
...
#define ERR_LISTINGRESPONSECODE		1128  /*successful | unsuccessful*/
...
#define ERR_UPER_ENCODE_LISTINGRESPONSECODE		1129  /**/
...
#define ERR_UPER_DECODE_LISTINGRESPONSECODE		1130  /**/
...
#define ERR_ACN_ENCODE_LISTINGRESPONSECODE		1131  /**/
...
#define ERR_ACN_DECODE_LISTINGRESPONSECODE		1132  /**/
...
#define ERR_LISTINGFILENAMESIZE		1133  /*(0..maxListingFileNameSizeLength)*/
...
#define ERR_UPER_ENCODE_LISTINGFILENAMESIZE		1134  /**/
...
#define ERR_UPER_DECODE_LISTINGFILENAMESIZE		1135  /**/
...
#define ERR_ACN_ENCODE_LISTINGFILENAMESIZE		1136  /**/
...
#define ERR_ACN_DECODE_LISTINGFILENAMESIZE		1137  /**/
...
#define ERR_LISTINGFILENAME		1138  /*(SIZE(0..maxListingFileNameSizeLength))*/
...
#define ERR_UPER_ENCODE_LISTINGFILENAME		1139  /**/
...
#define ERR_UPER_DECODE_LISTINGFILENAME		1140  /**/
...
#define ERR_ACN_ENCODE_LISTINGFILENAME		1141  /**/
...
#define ERR_ACN_DECODE_LISTINGFILENAME		1142  /**/
...
#define ERR_DIRECTORYLISTINGREQUEST		1163  /**/
#define ERR_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME_2		1150  /**/
#define ERR_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME_2		1160  /**/
...
#define ERR_UPER_ENCODE_DIRECTORYLISTINGREQUEST		1164  /**/
#define ERR_UPER_ENCODE_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME_2		1151  /**/
#define ERR_UPER_ENCODE_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME_2		1161  /**/
...
#define ERR_UPER_DECODE_DIRECTORYLISTINGREQUEST		1165  /**/
#define ERR_UPER_DECODE_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME_2		1152  /**/
#define ERR_UPER_DECODE_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME_2		1162  /**/
...
#define ERR_ACN_ENCODE_DIRECTORYLISTINGREQUEST		1166  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME_SIZE_UNINITIALIZED		1167  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME_SIZE		1143  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME		1148  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME_SIZE_UNINITIALIZED		1168  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME_SIZE		1153  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME		1158  /**/
...
#define ERR_ACN_DECODE_DIRECTORYLISTINGREQUEST		1169  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME_SIZE		1144  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGREQUEST_DIRECTORY_NAME		1149  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME_SIZE		1154  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGREQUEST_DIRECTORY_FILE_NAME		1159  /**/
...
#define ERR_DIRECTORYLISTINGRESPONSE		1200  /**/
#define ERR_DIRECTORYLISTINGRESPONSE_LISTING_RESPONSE_CODE_2		1175  /**/
#define ERR_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME_2		1187  /**/
#define ERR_DIRECTORYLISTINGRESPONSE_DIRECTORY_FILE_NAME_2		1197  /**/
...
#define ERR_UPER_ENCODE_DIRECTORYLISTINGRESPONSE		1201  /**/
#define ERR_UPER_ENCODE_DIRECTORYLISTINGRESPONSE_LISTING_RESPONSE_CODE_2		1176  /**/
#define ERR_UPER_ENCODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME_2		1188  /**/
#define ERR_UPER_ENCODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_FILE_NAME_2		1198  /**/
...
#define ERR_UPER_DECODE_DIRECTORYLISTINGRESPONSE		1202  /**/
#define ERR_UPER_DECODE_DIRECTORYLISTINGRESPONSE_LISTING_RESPONSE_CODE_2		1177  /**/
#define ERR_UPER_DECODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME_2		1189  /**/
#define ERR_UPER_DECODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_FILE_NAME_2		1199  /**/
...
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE		1203  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE_LISTING_RESPONSE_CODE		1173  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE_SPARE		1178  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME_SIZE_UNINITIALIZED		1204  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME_SIZE		1180  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME		1185  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_FILE_NAME_SIZE_UNINITIALIZED		1205  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_FILE_NAME_SIZE		1190  /**/
#define ERR_ACN_ENCODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_FILE_NAME		1195  /**/
...
#define ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE		1206  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE_LISTING_RESPONSE_CODE		1174  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE_SPARE		1179  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME_SIZE		1181  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_NAME		1186  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_FILE_NAME_SIZE		1191  /**/
#define ERR_ACN_DECODE_DIRECTORYLISTINGRESPONSE_DIRECTORY_FILE_NAME		1196  /**/
...
typedef union {
    cfdpOriginatingTransactionId originating_transaction_id;
...
#define ERR_MESSAGETOUSER		1222  /**/
#define ERR_MESSAGETOUSER_ORIGINATING_TRANSACTION_ID		1207  /**/
#define ERR_MESSAGETOUSER_DIRECTORY_LISTING_REQUEST		1212  /**/
#define ERR_MESSAGETOUSER_DIRECTORY_LISTING_RESPONSE		1217  /**/
...
#else
#define cfdpMessageToUser_constant {.kind = MessageToUser_originating_transaction_id_PRESENT, .u.originating_transaction_id = cfdpOriginatingTransactionId_constant}
#endif

void cfdpMessageToUser_Initialize(cfdpMessageToUser* pVal);

#define ERR_UPER_ENCODE_MESSAGETOUSER		1223  /**/
#define ERR_UPER_ENCODE_MESSAGETOUSER_ORIGINATING_TRANSACTION_ID		1208  /**/
#define ERR_UPER_ENCODE_MESSAGETOUSER_DIRECTORY_LISTING_REQUEST		1213  /**/
#define ERR_UPER_ENCODE_MESSAGETOUSER_DIRECTORY_LISTING_RESPONSE		1218  /**/
#define cfdpMessageToUser_REQUIRED_BYTES_FOR_ENCODING       243
#define cfdpMessageToUser_REQUIRED_BITS_FOR_ENCODING        1937

flag cfdpMessageToUser_Encode(const cfdpMessageToUser* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_MESSAGETOUSER		1224  /**/
#define ERR_UPER_DECODE_MESSAGETOUSER_ORIGINATING_TRANSACTION_ID		1209  /**/
#define ERR_UPER_DECODE_MESSAGETOUSER_DIRECTORY_LISTING_REQUEST		1214  /**/
#define ERR_UPER_DECODE_MESSAGETOUSER_DIRECTORY_LISTING_RESPONSE		1219  /**/
...
#define cfdpMessageToUser_REQUIRED_BITS_FOR_ACN_ENCODING        1946

#define ERR_ACN_ENCODE_MESSAGETOUSER		1225  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSER_ORIGINATING_TRANSACTION_ID		1210  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSER_DIRECTORY_LISTING_REQUEST		1215  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSER_DIRECTORY_LISTING_RESPONSE		1220  /**/

flag cfdpMessageToUser_ACN_Encode(const cfdpMessageToUser* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_ACN_DECODE_MESSAGETOUSER		1226  /**/
#define ERR_ACN_DECODE_MESSAGETOUSER_ORIGINATING_TRANSACTION_ID		1211  /**/
#define ERR_ACN_DECODE_MESSAGETOUSER_DIRECTORY_LISTING_REQUEST		1216  /**/
#define ERR_ACN_DECODE_MESSAGETOUSER_DIRECTORY_LISTING_RESPONSE		1221  /**/
...
#define ERR_MESSAGETOUSERWITHHEADER		1254  /**/
#define ERR_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_2		1251  /**/
...
#define ERR_UPER_ENCODE_MESSAGETOUSERWITHHEADER		1255  /**/
#define ERR_UPER_ENCODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_2		1252  /**/
#define cfdpMessageToUserWithHeader_REQUIRED_BYTES_FOR_ENCODING       243
#define cfdpMessageToUserWithHeader_REQUIRED_BITS_FOR_ENCODING        1937
...
#define ERR_UPER_DECODE_MESSAGETOUSERWITHHEADER		1256  /**/
#define ERR_UPER_DECODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_2		1253  /**/
...
#define ERR_ACN_ENCODE_MESSAGETOUSERWITHHEADER		1257  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSERWITHHEADER_MESSAGE_IDENTIFIER		1227  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSERWITHHEADER_MESSAGE_TYPE_UNINITIALIZED		1258  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSERWITHHEADER_MESSAGE_TYPE		1229  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER		1249  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_ORIGINATING_TRANSACTION_ID		1234  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_DIRECTORY_LISTING_REQUEST		1239  /**/
#define ERR_ACN_ENCODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_DIRECTORY_LISTING_RESPONSE		1244  /**/
...
#define ERR_ACN_DECODE_MESSAGETOUSERWITHHEADER		1259  /**/
#define ERR_ACN_DECODE_MESSAGETOUSERWITHHEADER_MESSAGE_IDENTIFIER		1228  /**/
#define ERR_ACN_DECODE_MESSAGETOUSERWITHHEADER_MESSAGE_TYPE		1230  /**/
#define ERR_ACN_DECODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER		1250  /**/
#define ERR_ACN_DECODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_ORIGINATING_TRANSACTION_ID		1235  /**/
#define ERR_ACN_DECODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_DIRECTORY_LISTING_REQUEST		1240  /**/
#define ERR_ACN_DECODE_MESSAGETOUSERWITHHEADER_MESSAGE_TO_USER_DIRECTORY_LISTING_RESPONSE		1245  /**/
...
#define ERR_TLV_LENGTH_VALUE_MESSAGE_TO_USER		1302  /**/
#define ERR_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_2		1294  /**/
flag cfdpTLV_length_value_message_to_user_IsConstraintValid(const cfdpTLV_length_value_message_to_user* pVal, int* pErrCode);

#define ERR_TLV_LENGTH_VALUE		1307  /**/
...
#define ERR_UPER_ENCODE_TLV		1313  /**/
#define ERR_UPER_ENCODE_TLV_LENGTH_VALUE		1308  /**/
#define ERR_UPER_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER		1303  /**/
#define ERR_UPER_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_2		1295  /**/
#define cfdpTLV_REQUIRED_BYTES_FOR_ENCODING       244
#define cfdpTLV_REQUIRED_BITS_FOR_ENCODING        1952

flag cfdpTLV_Encode(const cfdpTLV* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_TLV		1314  /**/
#define ERR_UPER_DECODE_TLV_LENGTH_VALUE		1309  /**/
#define ERR_UPER_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER		1304  /**/
#define ERR_UPER_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_2		1296  /**/
...
#define ERR_ACN_ENCODE_TLV		1315  /**/
#define ERR_ACN_ENCODE_TLV_TAG_UNINITIALIZED		1316  /**/
#define ERR_ACN_ENCODE_TLV_TAG		1260  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE		1310  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER		1305  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE		1292  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_IDENTIFIER		1262  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TYPE_UNINITIALIZED		1301  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TYPE		1264  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TO_USER		1284  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TO_USER_ORIGINATING_TRANSACTION_ID		1269  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TO_USER_DIRECTORY_LISTING_REQUEST		1274  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TO_USER_DIRECTORY_LISTING_RESPONSE		1279  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_LENGTH_UNINITIALIZED		1317  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_LENGTH		1299  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_2		1297  /**/
#define ERR_ACN_ENCODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TYPE_UNINITIALIZED_2		1318  /**/

flag cfdpTLV_ACN_Encode(const cfdpTLV* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_ACN_DECODE_TLV		1319  /**/
#define ERR_ACN_DECODE_TLV_TAG		1261  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE		1311  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER		1306  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_LENGTH		1300  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_2		1298  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE		1293  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_IDENTIFIER		1263  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TYPE		1265  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TO_USER		1285  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TO_USER_ORIGINATING_TRANSACTION_ID		1270  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TO_USER_DIRECTORY_LISTING_REQUEST		1275  /**/
#define ERR_ACN_DECODE_TLV_LENGTH_VALUE_MESSAGE_TO_USER_VALUE_MESSAGE_TO_USER_DIRECTORY_LISTING_RESPONSE		1280  /**/
